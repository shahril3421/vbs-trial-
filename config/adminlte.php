...
return [
    ...
    */
    ...
    'logo_img' => 'vendor/adminlte/dist/img/jata.png',
    ...
    */
    ...
    'preloader' => [
        ...
        'img' => [
            //'path' => 'vendor/adminlte/dist/img/AdminLTELogo.png',
            'path' => 'vendor/adminlte/dist/img/jata.png',
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Pengguna',
            //'url'  => 'penggunas',
            'route' => 'users.penggunas.index',
            //'active' => ['users/penggunas/*'],
            'icon' => 'fas fa-fw fa-user',
            'icon_color' => 'pink',
        ],
        [
        ...
        [
           ...
           //'active' => ['users/vehicles/*'],
           'icon' => 'fas fa-fw fa-bus',
           'icon_color' => 'fuchsia',
        ],

        ['header' => 'Menu Tempahan'],
        [
            'text' => 'Tempahan',
            //'url'  => 'bookings',
            'route' => 'users.bookings.index',
