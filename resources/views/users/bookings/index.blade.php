                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>{{ Carbon\Carbon::createFromFormat('D, d-m-Y H:i A',$item->start_date)->format('D, d-m-Y H:i A')}}</td>
                                  <td>{{ Carbon\Carbon::createFromFormat('D, d-m-Y H:i A',$item->end_date)->format('D, d-m-Y H:i A') }}</td>
